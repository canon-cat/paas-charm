...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            {
                "VALKEY_DB_CONNECT_STRING": "valkey://relation-1-abc123:supersecretpass@valkey-primary:6379",
                "VALKEY_DB_FRAGMENT": "",
                "VALKEY_DB_HOSTNAME": "valkey-primary",
                "VALKEY_DB_NETLOC": "relation-1-abc123:supersecretpass@valkey-primary:6379",
                "VALKEY_DB_PARAMS": "",
                "VALKEY_DB_PATH": "",
                "VALKEY_DB_PORT": "6379",
                "VALKEY_DB_QUERY": "",
                "VALKEY_DB_SCHEME": "valkey",
                "VALKEY_DB_USERNAME": "relation-1-abc123",
                "VALKEY_DB_PASSWORD": "supersecretpass",
